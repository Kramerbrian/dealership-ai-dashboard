 ...
 * - tier: 'tier1' = Free tier (PG only), 'tier2' = Pro tier (PG-13), 'tier3' = Enterprise (PG-13+)
 */
...
export interface Quote {
  ...
  quote: string;
  context_tag: string;
  subtletyIndex: number;
  usageCount: number;
  lastUsedTimestamp: number;
  tier: 'tier1' | 'tier2' | 'tier3';
  channelFocus?: string; // Optional: where this quote is best used
}

export const QuoteMatrix: Quote[] = [
    // --- Tier 1: PG-Rated Baseline (Free Tier) ---
    {
        id: 'WW-dream',
        ...
        lastUsedTimestamp: 0,
        tier: 'tier1',
        channelFocus: 'Onboarding Header, Landing Page'
    },
    {
        id: '2001-err',
        ...
        lastUsedTimestamp: 0,
        tier: 'tier1',
        channelFocus: 'Chatbot (System Message), Error Toast'
    },
    {
        id: 'ET-call',
        ...
        lastUsedTimestamp: 0,
        tier: 'tier1',
        channelFocus: 'Footer, Support Section'
    },
    {
        id: 'CE3K-data',
        ...
        lastUsedTimestamp: 0,
        tier: 'tier1',
        channelFocus: 'Dashboard Alert (Metric Spike)'
    },
    {
        id: 'Inter-destiny',
    ...
    // --- Crime / Strategy (PG-Sanitized) ---
    {
        ...
        lastUsedTimestamp: 0,
        tier: 'tier1',
        channelFocus: 'War Room Tab, Competitive Intel Report'
    },
    {
        id: 'MadMax-eternal',
        movieSource: 'Mad Max: Fury Road (Conceptual)',
        rating: 'PG',
        quote: "You will ride eternal, shiny and chrome!",
        context_tag: 'Endurance, Long-Term Strategy, Motivation',
        subtletyIndex: 3,
        usageCount: 0,
        lastUsedTimestamp: 0,
        tier: 'tier1',
        channelFocus: 'Onboarding Success, Executive Summary'
    },
    
    // --- Tier 2: Additional PG Quotes (Pro Tier) ---
    {
        id: 'Jaws-scale',
