...
echo -e "${BLUE}================================"
echo ""
echo "1. Root Directory: Leave EMPTY for root-level Next.js apps"
echo "   - If set to '.' or './', clear it (Vercel defaults to root)"
echo "   - For monorepos, use relative path like 'apps/web' (no './' prefix)"
