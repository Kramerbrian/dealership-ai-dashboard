...
export function ZeroClickDrawerGuard({ tier, children }: DrawerGuardProps) {
  ...
  const status = trial.get("zero_click_drawer");
      ...
      {!unlocked && (
        <div className="absolute inset-0 grid place-items-center">
          <div className="rounded-xl border border-white/15 bg-black/60 p-4 text-center text-sm text-white">
            <div className="mb-2 font-semibold">Zero-Click Drawer is locked on Basic</div>
            <div className="mb-3 text-white/80">Enable a 24h trial from Pricing to view inclusion gaps & recovery playbook.</div>
            <button
