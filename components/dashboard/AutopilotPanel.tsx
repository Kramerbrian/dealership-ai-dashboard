    ...
    <div className="px-4 md:px-6 py-6 md:py-8 space-y-6">
      ...
      <section className="rounded-3xl border border-white/10 bg-white/[0.04] p-5">
        ...
        <div className="mt-4 flex flex-wrap gap-3">
          <button className="h-9 px-4 rounded-full bg-white text-black text-sm font-medium hover:bg-neutral-100 transition">
            Enable Autopilot (Pro)
          </button>
          <button className="h-9 px-4 rounded-full border border-white/20 text-xs text-white/70 hover:bg-white/10 transition">
