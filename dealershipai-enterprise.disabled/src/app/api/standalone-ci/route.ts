...
// Completely standalone confidence interval calculations
// No imports from problematic files
...
export async function GET() {
  try {
    ...
    return NextResponse.json({
      success: true,
      message: "Confidence Interval Calculations Working!",
      examples: {
        ai_visibility: {
          scores: aiScores,
          result: aiCI,
    ...
    console.error('Standalone CI error:', error)
    return NextResponse.json(
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.error('Standalone CI calculation error:', error)
    return NextResponse.json(
