    ...
    return (
      <div className="min-h-screen bg-[var(--brand-bg,#0a0b0f)] text-white flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-white/60">Checking authentication status...</p>
        </div>
      </div>
    );
  }
        ...
        <div className="text-center max-w-md mx-auto">
          <div className="glass rounded-2xl p-8">
            ...
            <div className="space-y-2 text-sm text-white/60 mb-6">
              ...
              <p><strong>Provider:</strong> {session?.user?.image ? 'OAuth' : 'Unknown'}</p>
            </div>
      ...
      <div className="text-center max-w-md mx-auto">
        <div className="glass rounded-2xl p-8">
          ...
          <p className="text-white/70 mb-6">
            This page tests the OAuth authentication flow. Click a provider below to sign in.
          </p>
          ...
          <div className="mt-6 pt-6 border-t border-white/20">
            <a
              href="/auth/signin"
              className="text-[var(--brand-primary)] hover:text-[var(--brand-accent)] transition-colors"
            >
