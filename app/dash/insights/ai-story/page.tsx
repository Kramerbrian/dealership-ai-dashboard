      ...
      <main className="min-h-dvh bg-neutral-950 text-white">
        <div className="px-4 md:px-6 py-6 md:py-8 max-w-5xl">
          ...
          <section className="mt-6 grid gap-6 md:grid-cols-2">
            ...
            <div className="rounded-3xl border border-white/10 bg-white/[0.04] p-5">
              <div className="text-xs textWhite/50 uppercase tracking-[0.16em]">
                Timeline
              </div>
              <ul className="mt-3 space-y-3 text-sm textWhite/75">
                {data.history?.map((h: any, i: number) => (
                  <li key={i}>
                    <div className="text-xs textWhite/50">
                    ...
                    {h.events?.length > 0 && (
                      <ul className="mt-1 list-disc list-inside text-xs textWhite/50">
          ...
          <section className="mt-8 rounded-3xl border borderWhite/10 bgWhite/[0.04] p-5">
            ...
            <button className="mt-4 h-9 px-4 rounded-full bgWhite textBlack text-sm fontMedium hover:bgNeutral-100 transition">
              Turn on Autopilot
            </button>
          </section>
        </div>
