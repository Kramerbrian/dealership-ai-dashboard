...
interface dAIChatProps {
  dealerId: string;
  domain?: string;
  className?: string;
}

export default function dAIChat({ dealerId, domain, className = '' }: dAIChatProps) {
    ...
    <div className={`flex flex-col h-full bg-slate-900/80 border border-slate-800 rounded-2xl ${className}`}>
      ...
      <div className="p-4 border-b border-slate-800 flex items-center gap-3">
        ...
        <div className="flex-1">
          <h3 className="text-lg font-semibold text-white">dAI — AI Chief Strategy Officer</h3>
